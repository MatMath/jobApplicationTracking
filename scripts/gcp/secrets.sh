...
SECRETS=(NEXT_PUBLIC_SUPABASE_URL NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY NEXT_PUBLIC_LOGO_DEV_TOKEN NEXT_PUBLIC_GOOGLE_MAPS_BROWSER_KEY GOOGLE_MAPS_API_KEY)
